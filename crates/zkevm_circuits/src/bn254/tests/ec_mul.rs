pub mod test {
    ...
    use crate::bn254::tests::json::EC_MUL_TEST_CASES;
    use crate::bn254::tests::utils::assert::assert_equal_g1_points_affine;
    use crate::bn254::tests::utils::debug_success;
    use crate::bn254::{bn254_scalar_field_params, BN256Fr, BN256ScalarNNField};
    ...
    fn test_multiplication() {
        ...
        for (i, test) in EC_MUL_TEST_CASES.tests.iter().enumerate() {
            ...
            // Expected:
            let expected = test.expected.to_coordinates(cs);

            // Actual:
            let actual = mul(cs, point_nn, scalar_nn);

            // Making assertion and debug success if OK
            assert_equal_g1_points_affine(cs, actual, expected);
    ...
    fn debug_ecmul_performance() {
        ...
        let _ = mul(cs, point_nn, scalar_nn);
